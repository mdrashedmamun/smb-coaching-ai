                    ...
                    >
                        {isFail ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <h2 className="text-3xl font-bold text-white">{COPY.verdict.pass.headline}</h2>
                                <p className="text-xl text-gray-300 whitespace-pre-line">{COPY.verdict.pass.body}</p>
                                ...
                                >
                                    {COPY.verdict.pass.cta} <ArrowRight className="w-5 h-5 inline-block ml-2" />
                                </button>
                            </div>
                        )}
